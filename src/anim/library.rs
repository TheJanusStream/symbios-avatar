...
//!
//! **A development reference rather than a runtime motion source.** Locomotion
//! is generated by the procedural layer and the expressive roster lives in
//! [`super::gesture`] as descriptions, at a cost of the bytes of each
//! gesture's own description rather than of its frames. What a library is
//! good for is putting an imported motion beside a procedural one — which is
//! what the viewer's clip picker and `examples/locomotion` do.
//!
