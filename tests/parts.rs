...
fn the_underside_of_the_jaw_does_not_bulge() {
    ...
    // reports bulges and is blind to hollows, shelves and ramps. That was
    // `the_jaw_gives_up_its_reach_where_the_reference_does` (deleted with the
    // rest of the jaw-band rulers, #196 — under #193's order the render is the
    // authority in this band), and the sentence at the top of this comment —
    // that tightening this IS the fix — has not been true since #134
    // constructed the underside.
    //
